...
| - | ---------------------------------------------------------------------------------------------------------- | ----------- | -------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| 1 | **Reviewed markers per hunk** — toggle a hunk as "seen", persist it, dim on reopen                         | High        | Low      | Yes (small)      | Mechanical, immediate win on big PRs. Validates the whole state layer with the simplest possible schema.                       |
